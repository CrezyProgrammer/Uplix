...
import com.up.lix.lists.Usercalldata;
        ...
        mTokenget.child(friendid).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if(mAuth.getCurrentUser()!= null) {
                    ...
                    map.put("message", encryption.encryptOrNull(channelid + "#lix!!ah#&&lix#" + mAuth.getCurrentUser().getUid() + "#lix!!ah#&&lix#" + Global.nameLocal + "#lix!!ah#&&lix#" + Global.avaLocal));
